# Supabase Service - Aurelius

This document provides instructions for developers to set up and run the Supabase service locally within the Aurelius monorepo.
...
```sh
git clone https://github.com/your-username/Aurelius-dapp.git
cd Aurelius/services/supabase
```
...
```env
SUPABASE_PROJECT_ID=Aurelius-project-db
