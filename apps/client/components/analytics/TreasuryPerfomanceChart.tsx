	...
	return (
		<Card>
			<CardHeader className="pb-2">
				<CardTitle className="text-2xl font-bold">Treasury Performance</CardTitle>
				<CardDescription>Financial metrics and Treasury efficiency</CardDescription>
			</CardHeader>
								...
								<RadarChart outerRadius="80%" data={allocation}>
									...
									<Tooltip
										...
										formatter={(value: number, name: string) => [
											`${value}`,
											name === 'Aurelius' ? 'Aurelius' : 'Industry Average',
										]}
					...
					<TabsContent value="efficiency" className="mt-0 pt-4">
						<div className="w-full h-[400px] bg-black p-4 rounded-lg">
							<ResponsiveContainer width="100%" height="100%">
								...
								>
									<XAxis type="number" domain={[80, 100]} tick={{ fill: '#fff', fontSize: 12 }} />
									<YAxis
										type="category"
										dataKey="name"
										...
										width={100}
									/>
									<Tooltip content={<CustomTooltip />} cursor={{ fill: '#ffffff22' }} />
