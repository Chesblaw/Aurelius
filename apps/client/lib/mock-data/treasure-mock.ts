import type { AllocationData, BenchMarkDataItem, efficiencyData } from '../types/treasure-types'
...
export const allocation: AllocationData[] = [
	{ category: 'Governance', Aurelius: 9.2, IndustryAverage: 7.5 },
	{ category: 'Treasury', Aurelius: 8.5, IndustryAverage: 7.0 },
	{ category: 'Engagement', Aurelius: 7.8, IndustryAverage: 6.5 },
	{ category: 'Growth', Aurelius: 8.0, IndustryAverage: 7.2 },
	{ category: 'Innovation', Aurelius: 8.9, IndustryAverage: 7.8 },
	{ category: 'Security', Aurelius: 9.0, IndustryAverage: 7.6 },
]
...
export const efficiency: efficiencyData[] = [
	...
	{ name: 'Aurelius', score: 91, color: '#8b5cf6' }, // violet-500
